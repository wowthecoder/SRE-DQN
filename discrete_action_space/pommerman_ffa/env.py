...
class FfaEnvShim:
    ...
    def __init__(self, learner_slot: int = 0):
        self._env, self.learner_slot = make_ffa_env(learner_slot)
        self.n_agents = 4
        self._state = None
