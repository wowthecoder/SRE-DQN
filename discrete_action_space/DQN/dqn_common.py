...
class BaseDqnSrqAgent:
    """
    Common DQN agent logic with SRQAgent-style API compatibility.
    Subclasses only override how the bootstrap next-q is computed.
    """
...
class BasePrioritizedDqnSrqAgent(BaseDqnSrqAgent):
    """
    Common PER-based DQN agent logic.
    Subclasses define next-q bootstrap strategy and optionally network type.
    """
